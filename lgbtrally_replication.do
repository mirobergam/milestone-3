...
* This section runs t-tests (which are mean-comparison tests) on the number of
* actual participants and intended participants, dependent on whether or not they
...
* I believe this piece of code is bootstrapping for standard errors 
* on the groups who attended and the groups who intended to attend 
* but did not come. I believe it's only for the group who recieved 
* social esteem emails.
...
* Showing the mean who were reported to have attended the event for
* both newsletter and facebook-invite recipients
...
* "No-pickup" is defined in the paper as those who actually did attend 
* the event but did not pickup their ticket. This piece of code checks 
* for "no-pickups" within the different variables.
...
* If they reported that they attended in the post-event survey but were
* previously said to have not attending, changing no-pickup to one, because
* that person did not pick up their raffle ticket.  

replace nopickup=1 if reported_attended==1 & attended==0

* Calculating the no-pickup rate for the control group, the treatment 
* group, and those who recieved a facebook invitation

tab nopickup control
tab nopickup newsletter
tab nopickup facebook

* This is running a t-test on those who attended based on their replies
* to the post-event survey, where they were asked why they attended 
* (for a good cause, for social inclusion, for fun, for free time, etc). 
* by(esteem) split the answers into two columns: the average response for 
* those who recieved information-only and for those who recieved the social
* esteem invitation. 
...
* This is running a t-test on those who did not attend based on their 
* replies to the post-event survey, where they were asked why they did
* not attended (because they did not believe in the cause, because they 
* did not know anyone going, because it would not be fun fun, because 
* they didn't have the free time free time, etc). by(esteem) split the 
* answers into two columns: the average response for those who recieved
* information-only and for those who recieved the social esteem invitation. 
...
* This table shows the raw number of participants and the number of 
* participants who were within a 5-mile radius, who were women, who
* were democrats, who were of a certain education level, who were retired, ETC.  
...
* This test hows the demographic breakdown by age, education level,
* gender, political leaning of those who recieved the esteem invite 
* and those who recieved the information-only invite.  
...
* Running regression to see the relation between those who intended/attended
* and whether or not they received the social esteem newsletter, as well as 
* the relation to other demographic features. 
...
* I believe this is just documenting the number of survey respondents who
...
* Running regression to see the relation between those who REPORTED as
* attended and having received the social esteem newsletter, as well as
* the relation to other demographic features. 
